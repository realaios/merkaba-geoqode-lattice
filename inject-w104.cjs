...
if (html.includes('AFRAME.registerComponent("cosmic-magneto-acoustic-compressional-mode"')) {
...
const HTML_ANCHOR = '      <a-entity stellar-differential-rotation-cone></a-entity>';
