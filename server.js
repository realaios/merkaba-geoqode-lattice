...
function _seedPlaiApps() {
  const seed = [
    ...
    // Theatre
    { cat: "Theatre", name: "Interstellar: Tesseract Room", desc: "Navigate the fifth-dimensional bookshelf. Gravity anomalies respond to your position. Cooper's messages embedded.", dl: 312 },
    { cat: "Theatre", name: "Inception: Dream Layers", desc: "Descend through five dream levels. Each layer bends physics by 10×. Limbo sequence unlocks at depth 5.", dl: 287 },
    { cat: "Theatre", name: "Tron Legacy: Grid Arena", desc: "Light cycle arena in full VR. Identity disc combat with physics-accurate disc arcs. Daft Punk score reactive.", dl: 334 },
    { cat: "Theatre", name: "Arrival: Heptapod Chamber", desc: "Stand inside the alien vessel. Heptapod language evolves as you interact. Non-linear time experience.", dl: 256 },
    { cat: "Theatre", name: "Her: OS1 Apartment", desc: "Experience Theo's minimalist apartment. Samantha's voice responds contextually. Sunset city ambient loop.", dl: 198 },
    { cat: "Theatre", name: "Annihilation: The Shimmer", desc: "Walk the border of the Shimmer. DNA-warped flora reacts to gaze. Lighthouse beacon in the distance.", dl: 223 },
    { cat: "Theatre", name: "Moon: Sarang Base", desc: "Lunar helium-3 harvesting station. GERTY terminal is interactive. Dust storms reduce visibility dynamically.", dl: 178 },
    { cat: "Theatre", name: "Solaris: Space Station", desc: "Soviet-era orbital station above Solaris. The ocean surface shifts with Kelvin's emotional state.", dl: 167 },
    // Cinema
    { cat: "Cinema", name: "Nausicaä Toxic Jungle", desc: "Fly a Mehve glider through the toxic jungle. Ohmu herd migration triggers at altitude 200. Spore storm visualisation.", dl: 234 },
    { cat: "Cinema", name: "Castle in the Sky: Laputa", desc: "Explore the floating ruins of Laputa. Laputian robots guard the garden. Thunder of Laputa unlocks hidden areas.", dl: 201 },
    { cat: "Cinema", name: "Paprika: Dream Parade", desc: "March in the surrealist dream parade. Objects morph between themes. DC Mini interface lets you enter others' dreams.", dl: 189 },
    { cat: "Cinema", name: "Perfect Blue: Studio", desc: "Navigate Mima's fractured reality. Mirror reflections show alternate timelines. Psychological tension builds.", dl: 156 },
    { cat: "Cinema", name: "Serial Experiments Lain: Wired", desc: "Enter the Wired. Reality layers blur at connection depth > 3. Lain's whispers respond to dwell time.", dl: 212 },
    { cat: "Cinema", name: "Paranoia Agent: Shonen Bat", desc: "Walk the streets of Musashino. News broadcasts play from windows. Shonen Bat approaches at night.", dl: 178 },
    { cat: "Cinema", name: "Neon Genesis: Terminal Dogma", desc: "Descend to Terminal Dogma. Adam specimen chamber is interactive. Sea of LCL begins at depth 12.", dl: 267 },
    // Playbooks
    { cat: "Playbooks", name: "YC Application Writer", desc: "AI-assisted Y Combinator application. Answer frameworks for all 40 questions. Traction narrative builder.", dl: 423 },
    { cat: "Playbooks", name: "Seed Round Pitch Deck", desc: "12-slide seed deck template with AI-generated market sizing, competitive moat framing, and ask slide.", dl: 389 },
    { cat: "Playbooks", name: "Twitter Growth Playbook", desc: "30-day Twitter growth system. Hook formulas, reply cadence, follower funnel, and viral thread templates.", dl: 312 },
    { cat: "Playbooks", name: "App Store Optimisation", desc: "ASO framework for iOS and Android. Keyword research, screenshot A/B templates, review response scripts.", dl: 267 },
    { cat: "Playbooks", name: "Enterprise Sales Script", desc: "6-week enterprise sales cycle. Discovery call framework, champion map, POC proposal, and legal redline guide.", dl: 234 },
    { cat: "Playbooks", name: "Developer Relations Launch", desc: "DevRel GTM playbook. Hackathon kit, GitHub README templates, API docs style guide, community Discord setup.", dl: 198 },
    { cat: "Playbooks", name: "Newsletter Launch System", desc: "Launch a paid newsletter in 30 days. Beehiiv setup, lead magnet funnel, referral program, monetisation ladder.", dl: 289 },
    { cat: "Playbooks", name: "Affiliate Programme Builder", desc: "Set up an affiliate programme from scratch. Commission structures, tracking links, payout automation, legal terms.", dl: 245 },
    { cat: "Playbooks", name: "Customer Success Onboarding", desc: "90-day customer success programme. Onboarding milestones, check-in call scripts, health score dashboard.", dl: 178 },
    // Agents
    { cat: "Agents", name: "PR Outreach Agent", desc: "Identifies relevant journalists and publications. Crafts personalised pitch emails. Tracks open rates and follow-ups.", dl: 334 },
    { cat: "Agents", name: "Support Ticket Resolver", desc: "Auto-classifies Zendesk tickets, drafts responses from knowledge base, escalates edge cases to humans.", dl: 289 },
    { cat: "Agents", name: "Social Media Scheduler", desc: "Generates and schedules posts for X, LinkedIn, and Threads. Optimal timing based on audience analytics.", dl: 312 },
    { cat: "Agents", name: "Legal Contract Scanner", desc: "Reads PDF contracts, flags non-standard clauses, summarises obligations and risks, suggests redlines.", dl: 267 },
    { cat: "Agents", name: "Hiring Pipeline Agent", desc: "Screens CVs, ranks candidates by role fit, drafts interview questions, sends scheduling links automatically.", dl: 223 },
    { cat: "Agents", name: "Data Pipeline Monitor", desc: "Watches ETL jobs, alerts on data drift, generates quality reports, auto-reruns failed transformations.", dl: 198 },
    { cat: "Agents", name: "API Documentation Writer", desc: "Reads your Express/FastAPI code, generates OpenAPI spec, writes endpoint docs with curl examples.", dl: 256 },
    { cat: "Agents", name: "Onboarding Email Drip", desc: "AI-personalised onboarding sequences. Adapts based on user activation events. 7-email arc with branching logic.", dl: 312 },
    { cat: "Agents", name: "Market Research Compiler", desc: "Weekly market intelligence from Reddit, HN, G2, and Capterra. Summarises pain points and emerging competitors.", dl: 245 },
    { cat: "Agents", name: "Grant Writing Assistant", desc: "Researches applicable grants, drafts applications with milestone tables, tracks submission deadlines.", dl: 178 },
    // Codex
    { cat: "Codex", name: "Next.js Auth Starter", desc: "Next.js 14 with App Router, NextAuth v5, PostgreSQL sessions, role-based routing, and email magic links.", dl: 534 },
    { cat: "Codex", name: "React Native Boilerplate", desc: "Expo SDK 51 template: Zustand state, React Query, Stripe payments, push notifications, and OTA updates.", dl: 478 },
    { cat: "Codex", name: "FastAPI Microservice", desc: "Python FastAPI service: JWT auth, PostgreSQL async pool, Redis cache, Celery workers, Docker compose.", dl: 412 },
    { cat: "Codex", name: "GraphQL Gateway", desc: "Apollo Server 4 gateway with federation, DataLoader batching, persisted queries, and rate limiting.", dl: 356 },
    { cat: "Codex", name: "WebRTC Video Engine", desc: "Peer-to-peer video with TURN server fallback, recording, screen share, and virtual background support.", dl: 289 },
    { cat: "Codex", name: "Serverless Functions Kit", desc: "Cloudflare Workers templates: API gateway, image resize, auth proxy, edge caching, and R2 storage.", dl: 312 },
    { cat: "Codex", name: "Event Sourcing Pattern", desc: "CQRS + event sourcing with PostgreSQL event store, projections, snapshots, and replay tooling.", dl: 267 },
    { cat: "Codex", name: "OpenAI Streaming API", desc: "Server-sent events streaming from OpenAI. Token counting, cost tracking, prompt caching, and fallback models.", dl: 445 },
    { cat: "Codex", name: "Monorepo Turborepo Setup", desc: "Turborepo monorepo: shared UI library, API types, config packages, Changesets versioning, and CI pipeline.", dl: 389 },
    { cat: "Codex", name: "Vector DB Integration", desc: "pgvector + Pinecone dual-write. Embedding generation, similarity search, chunking strategies, RAG patterns.", dl: 334 },
    // Analytics
    { cat: "Analytics", name: "LTV Prediction Model", desc: "Machine learning LTV predictor using 90-day behavioural signals. Exports to Google Sheets or Notion.", dl: 289 },
    { cat: "Analytics", name: "Churn Predictor", desc: "Identifies at-risk users 14 days before churn. Triggers automated save sequences via email and in-app.", dl: 312 },
    { cat: "Analytics", name: "A/B Test Calculator", desc: "Statistical significance calculator for conversion experiments. Bayesian and frequentist modes. Segment breakdowns.", dl: 267 },
    { cat: "Analytics", name: "API Latency Monitor", desc: "P50/P95/P99 latency tracking per endpoint. Anomaly detection alerts when baselines shift by >20%.", dl: 234 },
    { cat: "Analytics", name: "Referral Source Tracker", desc: "UTM parameter analysis with first-touch and multi-touch attribution. Revenue by acquisition channel.", dl: 198 },
    { cat: "Analytics", name: "Database Performance Lens", desc: "Slow query log analyser. Index recommendations, query plan visualiser, and migration impact estimator.", dl: 245 },
    { cat: "Analytics", name: "Feature Adoption Heatmap", desc: "Tracks which features users actually use. Generates adoption funnel and identifies dead features.", dl: 178 },
    { cat: "Analytics", name: "Revenue Forecasting AI", desc: "90-day revenue forecast using ARIMA and growth model. Confidence intervals and scenario planning.", dl: 312 },
    // Integrations
    { cat: "Integrations", name: "Stripe → PostHog Sync", desc: "Syncs Stripe payment events to PostHog as custom events. Revenue-weighted funnel analysis enabled.", dl: 267 },
    { cat: "Integrations", name: "GitHub → Linear Bridge", desc: "Auto-creates Linear issues from GitHub PR labels. Syncs status, assignees, and cycle tracking.", dl: 234 },
    { cat: "Integrations", name: "Intercom → PostgreSQL", desc: "Full Intercom conversation history synced to your database. Enable complex querying and ML training.", dl: 198 },
    { cat: "Integrations", name: "Zapier Alternative Engine", desc: "Self-hosted workflow automation with 200+ triggers. No per-task pricing. Runs on Railway in minutes.", dl: 356 },
    { cat: "Integrations", name: "Shopify Order Processor", desc: "Syncs Shopify orders to PostgreSQL, triggers fulfillment workflows, generates packing slips and tracking updates.", dl: 312 },
    { cat: "Integrations", name: "Airtable → PostgreSQL", desc: "Airtable → PostgreSQL migration and live sync. Schema inference, type mapping, and webhook bridge.", dl: 245 },
    { cat: "Integrations", name: "Figma Design Tokens", desc: "Exports Figma design tokens to CSS variables, Tailwind config, and React Native StyleSheet. Auto-syncs on file change.", dl: 289 },
    { cat: "Integrations", name: "Plaid Bank Feeds", desc: "Fetches bank transaction data via Plaid. Categorises spend, detects anomalies, exports to accounting tools.", dl: 223 },
    { cat: "Integrations", name: "SendGrid Transactional", desc: "SendGrid email integration with template management, unsubscribe handling, delivery analytics, and list hygiene.", dl: 267 },
    // Utilities
    { cat: "Utilities", name: "SQL Query Builder", desc: "Visual SQL query builder with PostgreSQL-specific functions, CTEs, window functions, and explain plan viewer.", dl: 445 },
    { cat: "Utilities", name: "API Rate Limit Simulator", desc: "Test your API under rate limit pressure. Configurable burst patterns, token bucket simulation, stress tests.", dl: 312 },
    { cat: "Utilities", name: "Docker Compose Generator", desc: "Generates docker-compose.yml from your Railway config. Service dependencies, health checks, volumes.", dl: 389 },
    { cat: "Utilities", name: "OpenAPI Spec Validator", desc: "Validates OpenAPI 3.1 specs. Checks for schema conflicts, missing examples, and security definitions.", dl: 267 },
    { cat: "Utilities", name: "Cron Expression Builder", desc: "Visual cron expression editor with natural language parsing. Timezone-aware next-run preview.", dl: 334 },
    { cat: "Utilities", name: "JSON Schema Generator", desc: "Infers JSON Schema from sample data. Handles nested objects, arrays, nullable fields, and $ref patterns.", dl: 289 },
    { cat: "Utilities", name: "Git History Analyser", desc: "Visualises commit velocity, contributor trends, hotspot files, and technical debt accumulation over time.", dl: 245 },
