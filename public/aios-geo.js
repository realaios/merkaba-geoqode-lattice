  ...
  var AIOS = {
    ...
    init: function (options) {
      ...
      canvas.style.cssText =
        "display:block;width:100%;height:100%;border-radius:inherit;background:#03050d";
    ...
    embed: function (selector, options) {
      ...
      for (var i = 0; i < elements.length; i++) {
        var inst = this.init(
          Object.assign({}, options || {}, { target: elements[i] }),
        );
  ...
  function autoInit() {
    ...
    for (var i = 0; i < els.length; i++) {
      ...
      AIOS.init({
        ...
        frequency:
          parseInt(el.getAttribute("data-aios-freq") || "0", 10) || undefined,
      });
    }
  }
