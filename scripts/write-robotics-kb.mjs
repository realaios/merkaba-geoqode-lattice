const jwt = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MSwiZW1haWwiOiJicmFkbGV5bGV2aXRhbkBnbWFpbC5jb20iLCJyb2xlIjoiYWRtaW4iLCJpc0FkbWluIjp0cnVlLCJwZXJtaXNzaW9ucyI6WyJhbGwiXSwiaWF0IjoxNzc4MjIxNjQ1LCJleHAiOjE4MDk3NTc2NDV9.WVN5q8r3CbQaUoxpswjrKg8lKyg3Ch2c7poCS2HFP-w";
  ...
  data: {
    ...
    layers: {
      layer1_control_safety: {
        ...
        purpose: "Real-time movement, obstacle avoidance, safety-critical reliability"
      },
      layer2_aios_overlay: {
        label: "AIOS Overlay",
        capabilities: [
    ...
    integration_points: {
      tesla_optimus: "AIOS sits above the Bot Brain SOC as a trust and compression layer for perception/action pipelines",
      boston_dynamics_spot_atlas: "AIOS integrates with ROS topics, wrapping them in resonance handshakes for adaptive trust and visualization"
    },
    what_this_enables: {
      humanoids_optimus: [
    ...
    competitive_differentiation: "Neither Tesla Optimus nor Boston Dynamics currently have: resonance handshake dual-attestation, semantic compression of sensor streams into resonance signatures, or affective display intelligence. Their systems are deterministic robotics stacks (Tesla FSD-derived neural nets, BD ROS + proprietary SDK) — excellent for locomotion, balance, and task execution — but lacking AIOS's adaptive self-evolving intelligence layer.",
    aios_uniqueness: "No other robotics OS today offers resonance-based self-evolution. AIOS does not compete with locomotion stacks — it overlays them with an intelligence layer that evolves itself from every handshake.",
    diagram_concept: "Layered architecture: Control & Safety (base) → AIOS Overlay (middle: resonance handshake, semantic compression, affective display, governance loop) → Emergent Intelligence Loop (top: self-evolution, adaptive coordination, public transparency)"
  }
};

const resp = await fetch('https://api.getbrains4ai.com/api/knowledge/aios-robotics-hybrid-architecture', {
  method: 'POST',
  headers: {
