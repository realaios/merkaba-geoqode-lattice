...
if (html.includes("<a-entity merkaba-starship>")) {
  console.log("[1/2] HTML entity already present");
  ok++;
  ...
  ok++;
  console.log("[1/2] HTML entity injected");
} else {
  errors.push(
    "[1/2] FAIL \u2014 HTML anchor not found (magnetohydrodynamic-jet)",
  );
}
...
if (html.includes('AFRAME.registerComponent("merkaba-starship",')) {
  ...
  ok++;
  console.log("[2/2] merkaba-starship JS injected");
} else {
